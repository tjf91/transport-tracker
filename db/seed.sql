...
(id serial primary key, date_created date, lat float, lng float, type varchar(100),city varchar(100),state varchar(30) amount int, total decimal, trip_id int references trips(id));
